#!/usr/bin/perl
# Credit to Stephen Ostenmiller
# https://askubuntu.com/questions/26056/where-are-gnome-keyboard-shortcuts-stored#answer-217310
# https://askubuntu.com/users/53750/stephen-ostermiller; https://ostermiller.org/
